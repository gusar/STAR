...
class ETLControl(object):
    def __init__(self, db_dict, batch_limit=DEFAULT_BATCH_SIZE):
        """
        :param db_dict: dict of starging, archive, clean connectors.
        """
        self.batch_limit = batch_limit
        self.staging = db_dict['staging']
        self.clean = db_dict['clean']
        self.archive = db_dict['archive']
    ...
    def load_staging(self):
        return self.staging.find({}, self.batch_limit)
